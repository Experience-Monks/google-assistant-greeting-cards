...
class LogController {
  ...
  log(level, msg, meta) {
    ...
    let userId = (meta.hasOwnProperty('user')) ? meta.user : undefined;
    let metadata = Object.assign({}, meta || {}, this.config.meta, errorMeta),
      data = (userId) ? Object.assign({user: userId}, {msg}, metadata, {_tags: tags}) : Object.assign({msg}, metadata, {_tags: tags});
